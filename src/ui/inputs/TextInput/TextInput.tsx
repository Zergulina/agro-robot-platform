...
const TextInput : React.FC<TextInputProps> = ({ value, setValue, disabled = false, autocomplete = "off", label, placeholder, regex, wrongMessage, isWrongBlock, rightIcon, isHidden, className, inputClassName }) => {
